report 50100 "My Sales - Invoice"
{
    // EE7.10 - added fields: "Reference No.","Registration No.","SWIFT Code","IBAN"
    // EE7.10 - modified function: DocumentCaption()
    DefaultLayout = RDLC;
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(CompanyInfoRegNoCptn; CompanyInfo.FIELDCAPTION("Registration No."))
                    {
                    }
                    column(CompanyInfoIBAN; CompanyInfo.IBAN)
                    {
                    }
                    column(CompanyInfoIBANCptn; CompanyInfo.FIELDCAPTION(IBAN))
                    {
                    }
                    column(CompanyInfoSWIFT; CompanyInfo."SWIFT Code")
                    {
                    }
                    column(CompanyInfoSWIFTCptn; CompanyInfo.FIELDCAPTION("SWIFT Code"))
                    {
                    }
                    column(SalesInvReferenceNo; '')
                    {
                    }
                    column(SalesInvReferenceNoCptn; 'EE Ref No.')
                    {
                    }
